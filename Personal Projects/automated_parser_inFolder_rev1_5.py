...
def parseFiles(parseRawFlag):
    ...
    try:
        ...
        times = parseLog(str(pdir[0]),str(":SDD"))
        ...
        for filename in os.listdir(str(pdir[0])):
            ...
            if filename.endswith(".bin"):
                ...
                csvWrite_BIN(namepart, file_count, pdir[0], gyro_x, gyro_y, gyro_z, acc_x, acc_y, acc_z)
                ...
                with open(str(pdir[0]) + "halt.log", "r+") as log:
                    ...
                    csvWrite_Smoke(times, pdir[0], mc10p0, mc2p5, mc4p0, mc10p0, nc0p5, nc1p0, nc2p5, nc4p0, nc10p0)              
